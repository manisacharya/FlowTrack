...
// Insert log for target date
$pdo->prepare('INSERT IGNORE INTO habit_logs (habit_id, log_date) VALUES (:hid, :d)')->execute([':hid' => $id, ':d' => $target]);

// Recompute last_marked as the most recent log
...
// Recompute streak: count consecutive logs backwards from last_marked by frequency step
$streak = 0;
if ($lastMarked) {
